...
document.body.onkeyup = function (e){ // Jumps with spacebar
...
function deathCheck(pipes){
    ...
    if((characterTop>550)||((pipeLeft<75)&&(pipeLeft>-30)&&((characterTop<openingTop+311)||(characterTop>openingTop+420)))){ //hitboxes ((floor)||(leftPipe)&&(rightPipe)||(openingTop)||(openingBottom))
        gameReset();
    }
}
