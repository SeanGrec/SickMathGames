...
<body>
  ...
  <nav class="main-nav-container">
    ...
    <label class="main-nav-title">Instructions</label>
    <label class="main-nav-subtitle">Flappybird </label><span>Press the spacebar to jump through the green pipes! *1920px WIDTH ONLY*</span>
    <label class="main-nav-subtitle">Add Em Up! </label><span>Add or subtract as many numbers as you can!</span>
    <label class="main-nav-subtitle">React </label><span>Click as fast as possible when prompted! The lower time the better!</span>
  </nav>
</body>
